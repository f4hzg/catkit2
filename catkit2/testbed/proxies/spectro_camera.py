...
class SpectroCameraProxy(ServiceProxy):
    """
    A proxy class to add some convenience methods for the spectro camera of PLANETES
    """

    def get_cube(self, num_exposures):
        """
        Return a cube made of given number of exposures
        """
        cube = []
